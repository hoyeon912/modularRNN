...
def main():
    ...
    live_plot = LiveTrainingPlot(title="modRNN/test_cartpole.py", metrics=("loss", "accuracy", "reward"))
    accuracy = train(model, train_loader, test_loader, device, epochs=25, live_plot=live_plot)
